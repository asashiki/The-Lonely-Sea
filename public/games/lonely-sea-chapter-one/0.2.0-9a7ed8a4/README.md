...
把本目录完整放到 `public/games/lonely-sea-chapter-one/0.2.0-9a7ed8a4/`，并在 Blog 的 release registry 登记 slug、releaseId 与目录。允许宿主：http://127.0.0.1:4321、http://localhost:4321。
