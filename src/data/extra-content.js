...
export const projectTagOrder = Object.freeze([
  "Python", "Java", "Kotlin", "TypeScript", "JavaScript", "PowerShell", "WebGAL", "Docker", "Playwright",
...
export const projectItems = Object.freeze([
  ...
  {
    title: copy("浅仪式之墓", "Asagi's Grave", "浅儀式の墓"),
    mark: "ASAGI / GRAVE",
    category: "web",
    tags: Object.freeze(["Game", "维护中"]),
    art: "/assets/cg/generated/scene-19.webp",
    description: copy(
      "一座关于 vibe coding 的网页墓，收着短剧、手记、回响和雨声。",
      "A web grave for vibe coding, with short scenes, notes, echoes, and rain.",
      "vibe coding をめぐるウェブの墓。短編、手記、こだま、雨音を収める。",
    ),
    github: "https://github.com/asashiki/asagi-grave",
  ...
  },
  {
    ...
    github: "https://github.com/asashiki/show",
  ...
  },
  {
    ...
    mark: "OBLIVION / HAVEN",
    category: "docs",
    tags: Object.freeze(["AIGC", "维护中"]),
    art: "/assets/cg/generated/scene-20.webp",
    description: copy(
      "跨 AI 的长期资料入口，收录项目路由、立绘差分与 Galgame BGM 技能。",
      "A shared reference hub for AI, project routes, sprite variations, and Galgame BGM skills.",
      "AI 共通の長期資料入口。プロジェクト案内、立ち絵差分、Galgame BGM のスキルを収録。",
    ),
  ...
  {
    title: copy("切条", "Splicer for X", "切条"),
    mark: "QIETIAO / SPLICER",
    category: "web",
    tags: Object.freeze(["TypeScript", "维护中"]),
    art: "/assets/cg/generated/scene-09.webp",
    description: copy(
      "在浏览器里把视频与图片切成 X 横滑连环帖，或转成 Pixiv 动图，文件不上传。",
      "Slice videos and images into X swipe posts or Pixiv animations, entirely in your browser.",
      "動画や画像を X の横スワイプ投稿や Pixiv のうごイラに。ファイルはアップロードせずブラウザ内で処理。",
    ),
    github: "https://github.com/asashiki/qietiao",
    href: "https://qietiao.grok.me/",
  },
  {
    title: "Afterglow",
    mark: "AFTER / GLOW",
    category: "web",
    tags: Object.freeze(["JavaScript", "维护中"]),
    art: "/assets/cg/generated/scene-05.webp",
    description: copy(
      "按年份保存动画、游戏与制作公司官网的截图，留下那些即将消失的页面。",
      "A chronological screenshot archive of anime, game, and studio websites before they disappear.",
      "アニメ・ゲーム・制作会社の公式サイトの姿を、スクリーンショットで年順に残す私家版アーカイブ。",
    ),
    github: "https://github.com/asashiki/afterglow-web",
    href: "https://after-glow.grok.me/",
  },
  {
    title: "VibeGAL Face Motion",
    mark: "VIBEGAL / MOTION",
    category: "tool",
    tags: Object.freeze(["TypeScript", "AIGC", "Galgame", "维护中"]),
    art: "/assets/cg/generated/scene-14.webp",
    description: copy(
      "从一张透明立绘生成眨眼与三态口型部件，导出可直接检查的动画运行包。",
      "Turn a transparent character sprite into blinking and three-state mouth parts with a runnable preview.",
      "透明な立ち絵からまばたきと三段階の口パーツを生成し、そのまま確認できる実行パッケージに。",
    ),
    github: "https://github.com/asashiki/vibegal-studio",
  },
  {
    title: "Xmarks",
    mark: "X / MARKS",
    ...
    description: copy(
      "本地浏览器扩展：导出 X 书签、收藏夹与点赞，支持 JSON、CSV、媒体和内容筛选。",
      "A local browser extension for exporting X bookmarks, folders, and likes as JSON, CSV, or media, with content filters.",
      "X のブックマーク・フォルダ・いいねを JSON、CSV、メディアで書き出すローカル拡張。内容の絞り込みにも対応。",
    ),
  ...
  },
  {
    ...
    mark: "RSS / TELEGRAM",
    category: "tool",
    tags: Object.freeze(["Python", "维护中"]),
    art: "/assets/cg/generated/scene-16.webp",
    description: copy(
      "基于 GitHub Actions 的 RSS 推送工具，支持多源、去重与图片，发送到 Telegram 频道或群组。",
      "A GitHub Actions RSS relay with multiple feeds, deduplication, and images for Telegram channels or groups.",
      "GitHub Actions で RSS を Telegram に配信。複数ソース、重複排除、画像送信に対応。",
    ),
    github: "https://github.com/asashiki/rss-telegram-pusher",
  },
  {
    title: "waifu-terminal",
    mark: "WAIFU / TERMINAL",
    category: "tool",
    tags: Object.freeze(["PowerShell", "维护中"]),
    art: "/assets/cg/generated/scene-18.webp",
    description: copy(
      "Catppuccin Mocha 配色与二次元壁纸的 Windows Terminal 配置，可由 AI Agent 安装。",
      "A Windows Terminal setup with Catppuccin Mocha and anime wallpapers, installable by an AI agent.",
      "Catppuccin Mocha とアニメ壁紙を組み合わせた Windows Terminal 設定。AI Agent による導入に対応。",
    ),
    github: "https://github.com/asashiki/waifu-terminal",
  },
  {
    ...
    github: "https://github.com/asashiki/bpm-asashiki-com",
  ...
  },
  {
    ...
    github: "https://github.com/asashiki/rhythm-game",
  ...
  },
  {
    ...
    github: "https://github.com/asashiki/asashiki-design",
  },
  {
    title: "vibegame",
    mark: "VIBE / GAME",
    ...
    github: "https://github.com/asashiki/vibe-game",
  },
  {
    title: "sticker-mcp",
    mark: "STICKER / MCP",
